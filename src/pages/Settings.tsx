              ...
              <div className="p-7">
                ...
                <div className="mb-6">
                  ...
                  <div className="flex justify-end gap-4.5">
                    ...
                    <button
                      className="flex justify-center rounded bg-meta-4 py-2 px-6 font-medium text-gray hover:shadow-1"
                      type="submit"
            ...
            <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
              ...
              <div className="p-7">
                <form action="#">
                  ...
                  <div
                    id="FileUpload"
                    className="relative mb-5.5 block w-full cursor-pointer appearance-none rounded border-2 border-dashed border-meta-4  py-4 px-4 dark:bg-boxdarksm:py-7.5"
                  >
                    <input
                      type="file"
                      accept="image/*"
                  ...
                  <div className="flex justify-end gap-4.5">
                    ...
                    <button
                      className="flex justify-center rounded bg-meta-4 py-2 px-6 font-medium text-gray hover:bg-opacity-70"
                      type="submit"
                    >
                      Save
                    </button>
