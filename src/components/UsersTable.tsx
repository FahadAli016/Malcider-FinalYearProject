    ...
    return (
      ...
      {data.map((item, index) => (
        <tr key={index}>
          ...
          <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
            <p className={`inline-flex rounded-full py-1 px-3 text-sm font-medium ${item.status === 'Paid' ? 'text-success bg-success bg-opacity-10' : 'text-danger bg-danger bg-opacity-10'}`}>
              {item.status}
            </p>
          </td>
          <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
