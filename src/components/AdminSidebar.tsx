...
import {useColorChange} from '../../src/app/store';
...
const AdminSidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <aside
      ref={sidebar}
      className={`absolute left-0 top-0 z-9999 flex h-screen w-72.5 flex-col overflow-y-hidden bg-white  dark:text-white duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0 ${
        sidebarOpen ? 'translate-x-0' : '-translate-x-full'
      }`}
    >
      {/* <!-- SIDEBAR HEADER --> */}
      <div className="flex items-center justify-between gap-2 px-6 pt-3 lg:pt-3">
        <NavLink to="/admin/MalwareAnalytics">
      ...
      <div className="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
        ...
        <nav className="mt-5 py-4 px-4 lg:mt-1 lg:px-6">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              <li>
                {' '}
                <NavLink
                  to="/admin/MalwareAnalytics"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 dark:text-white duration-300 ease-in-out hover:bg-meta-4 hover:text-white dark:hover:bg-meta-4 ${
                    (pathname === '/admin/MalwareAnalytics' ||
                      pathname.includes('admin/MalwareAnalytics')) &&
                    'bg-meta-4 text-white dark:bg-meta-4'
                  }`}
                >
                  <svg
                    className="fill-current"
              ...
              <li>
                <NavLink
                  ...
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 dark:text-white duration-300 ease-in-out hover:bg-meta-4 hover:text-white dark:hover:bg-meta-4 ${
                    (pathname === '/admin/UserAnalytics' ||
                      pathname.includes('admin/UserAnalytics')) &&
                    'bg-meta-4 text-white dark:bg-meta-4'
                  }`}
                >
                  <svg
              ...
              <li>
                <NavLink
                  ...
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium dark:text-white text-bodydark1 duration-300 ease-in-out hover:bg-meta-4 hover:text-white dark:hover:bg-meta-4 ${
                    pathname.includes('RegisteredUsers') && 'bg-meta-4 text-white'
                  }`}
                >
                  <svg
                    className="fill-current"
              ...
              <li>
                <NavLink
                  to="/admin/ScannedFiles"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium dark:text-white text-bodydark1 duration-300 ease-in-out hover:bg-meta-4 hover:text-white dark:hover:bg-meta-4 ${
                    pathname.includes('ScannedFiles') && 'bg-meta-4 text-white'
                  }`}
                >
                  <svg
                    className="fill-current"
              ...
              <li>
                <NavLink
                  to="/scanfile"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 dark:text-white duration-300 hover:bg-meta-4 hover:text-white ease-in-out  dark:hover:bg-meta-4 ${
                    pathname.includes('scanfile') && 'bg-meta-4 text-white'
                  }`}
                >
                  <svg
                    className="fill-current"
              ...
              <li>
                <NavLink
                  to="/settings"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium dark:text-white hover:bg-meta-4 hover:text-white text-bodydark1 duration-300 ease-in-out  dark:hover:bg-meta-4 ${
                    pathname.includes('settings') && 'bg-meta-4 text-white'
                  }`}
                >
                  <svg
                    className="fill-current"
          ...
          <div className="flex justify-center mt-45">
            <Link
              to="/"
              className="inline-flex items-center justify-center rounded-md bg-primary py-2 px-6  dark:text-white text-center font-medium text-white hover:bg-opacity-90 lg:px-6 xl:px-6"
            >
              Log Out
            </Link>
          </div>
